...
class MyValidators {
  ...
  static String? displayDescriptionValidator(String? displayDisc) {
    if (displayDisc == null || displayDisc.isEmpty) {
      return 'display detail cannot be empty'.tr;
    }
    if (displayDisc.length < 4 || displayDisc.length > 10000) {
      return 'display detail must be between 3 and 10000 characters'.tr;
    }
